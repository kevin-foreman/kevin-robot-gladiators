var fightOrSkip = function() {
  // ask player if the want to fight or skip
...
var endGame = function() {
  ...
  if (playerInfo.money > highScore) {
    ...
    alert(playerInfo.name + " now has the high score of " + playerInfo.money + ", Hell yeah!");
  }
  else {
    alert(playerInfo.name + " did not beat the high score of " + highScore + ". Maybe next time, sucka!")
  }
